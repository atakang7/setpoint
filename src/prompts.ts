...
export function continueCoderPrompt(northStar: NorthStar, judgment: Judgment, custom?: string): string {
...
export function juryFailureCoderPrompt(northStar: NorthStar, verdicts: JuryVerdict[], custom?: string): string {
...
export function judgePrompt(task: string, northStar: NorthStar, observation: Observation, custom?: string): string {
...
export function juryPrompt(task: string, northStar: NorthStar, observation: Observation, custom?: string): string {
